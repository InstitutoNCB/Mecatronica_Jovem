/*
* CNC - LEONARDO DA VINCI
* 
* Aqui neste código é possível encontrar partes do código comentadas e que serve para modificações
* caso se interesse em estudar e aprender mais sobre programação para CNC. Também contém link para melhor compreensão
* sobre a formação de desenhos.
* Bom projeto!
*/
...
const int penZDown = 152; //Ajuste aos poucos para que a caneta encoste perfeitamente no papel
